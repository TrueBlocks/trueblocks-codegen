...
|     |                                                    | ~~Apply the chosen name across the codebase~~                                                      | ~~Done~~    |
...
| 10  | Improve Keyboard Navigation                        | Detail current usage of keyboard shortcuts                                                         |             |
|     |                                                    | Discuss industry standard approaches to keyboard shortcuts in Wails apps                           |             |
|     |                                                    | Discuss the issue of keyboard focus in a Wails app. Discuss the same for a React app.              |             |
|     |                                                    | How does keyboard focus work? How does focus change if the window is minimized, loses focus, etc.? |             |
|     |                                                    | Document table navigation needs (e.g., arrow keys, Home/End)                                       |             |
|     |                                                    | Discuss "Enter" behavior and editing/validation options                                            |             |
|     |                                                    | Summarize keyboard navigation recommendations                                                      |             |
| 11  | ~~Leverage Wails 3.0 for Multi-Window Apps~~       | ~~Research Wails 3.0 multi-window API and capabilities~~                                           | ~~Delayed~~ |
|     |                                                    | ~~Propose 2-3 use cases for multiple windows (e.g., settings, help)~~                              | ~~Delayed~~ |
|     |                                                    | ~~Outline a plan to implement multi-window support~~                                               | ~~Delayed~~ |
